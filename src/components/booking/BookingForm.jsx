          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="patientName" name="patientName" defaultValue={user?.name || ""} required placeholder="Your full name" />
              </div>
              <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" name="email" type="email" value={user?.email || ""} readOnly disabled className="bg-muted" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border">
              ...
              <Button type="submit" size="lg" disabled={submitting} className="group/btn">
            ...
            {error && (
              <p className="text-sm text-destructive font-medium text-center pt-2">{error}</p>
            )}
          </form>
        </CardContent>
      </Card>
