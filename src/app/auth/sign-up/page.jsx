...
export default function RegisterPage() {
  ...
  const socialHandler = async () => {
    ...
    if (error) {
      triggerToast(error.message || "Social login failed.");
    }
  ...
  return (
    <div className="w-full min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50/50 dark:bg-slate-900/40 transition-colors duration-300">
      <div className="max-w-md w-full">
        ...
        {/* Glassmorphic Registration Card - No floating/movement animations */}
        <div className="glass rounded-3xl p-6 pt-3 sm:p-8 sm:pt-3 shadow-xl border border-slate-200 dark:border-slate-800 transition-all duration-300 bg-white/80 dark:bg-slate-950/80">
          ...
          {/* Toggle Login Link - Moved here, above social sign-in */}
